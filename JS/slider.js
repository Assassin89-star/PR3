...
const apartamentArea = document.getElementById('apartament');
...
let aparArea = document.getElementById('apartament_area');
...
function replaceText() {
    if (click == 0) {
        ...
        apartamentArea.innerHTML = paragraphs[click].text2;
...
function mobReplaceText() {
    ...
    if (click == 0) {
        ...
        apartamentArea.innerHTML = paragraphs[click].text2;
        repairTime.innerHTML = paragraphs[click].text3;
        aparArea.style.marginLeft = 34 + 'px';
    } else {
        sity.innerHTML = paragraphs[click].text1;
        apartamentArea.innerHTML = paragraphs[click].text2;
        repairTime.innerHTML = paragraphs[click].text3;
